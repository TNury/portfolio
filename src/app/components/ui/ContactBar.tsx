...
export const ContactBar = () => {
  return (
    <div className='fixed bottom-0 left-0 right-0 z-10 hidden flex-col items-center gap-8 md:flex pointer-events-none'>
      <div className='w-full flex justify-end max-w-screen-lg'>
        <div className='flex w-16 flex-col items-center gap-8 pointer-events-auto'>
          <a
            href='https://www.linkedin.com/in/yuri-souza-b26bb3180/'
            target='_blank'
            className='group relative flex items-center'>
            <span className='absolute -left-80 hidden w-80 pr-4 text-right text-lg leading-none text-text-2 group-hover:block'>
              Yuri Souza
            </span>
