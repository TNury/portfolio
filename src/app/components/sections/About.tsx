...
export const About = () => {
  return (
    <Section className='flex flex-col gap-20'>
      <h2 className='text-4xl font-bold text-text-2'>Sobre mim.</h2>
      <div className='flex flex-col gap-16'>
        <div className='flex flex-col gap-8'>
          ...
          <div className='flex flex-col gap-2'>
            <h3 className='text-xl-b font-bold text-text-2'>Web</h3>
          ...
          <div className='flex flex-col gap-2'>
            <h3 className='text-xl-b font-bold text-text-2'>Mobile</h3>
            <div className='flex flex-col gap-1'>
        ...
        <div className='flex w-full items-center justify-center'>
          <div className='border-2 group relative w-full max-w-md border-accents-2'>
            <Image
